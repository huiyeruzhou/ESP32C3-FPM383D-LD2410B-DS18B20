 ...
 *
 * File: main.cpp
 * Description: the main entry of the fan device
 * Version: V1.0.0
 * Date: 2023/08/23
 * Author: YuHongli
 * Revision History:
...
int GPIO_Init(void)
{
    ...
    gpio_isr_handler_add(CONFIG_GPIO_NUM, gpio_isr_handler, reinterpret_cast<void *>(CONFIG_GPIO_NUM));
